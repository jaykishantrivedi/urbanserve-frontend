...
export function ProviderProfileErrorState({ onBack }) {
    return (
        <div className="p-6 flex flex-col items-center justify-center min-h-[60vh] text-center">
            <XCircle size={40} className="text-red-300 mb-3" />
            <p className="text-lg font-bold text-gray-700">Provider Not Found</p>
            <p className="text-sm text-gray-400 mt-1">This provider may have been deleted or the ID is invalid.</p>
            <button
                onClick={onBack}
